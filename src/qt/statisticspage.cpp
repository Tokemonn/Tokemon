...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " TKM" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " TKM" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " TKM");
    }
