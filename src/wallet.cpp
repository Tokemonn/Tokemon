...
// tokemon: total coins staked (non-spendable until maturity)
...
// tokemon: check 'spent' consistency between wallet and txindex
// tokemon: fix wallet spent state according to txindex
...
// tokemon: disable transaction (only for coinstake)
